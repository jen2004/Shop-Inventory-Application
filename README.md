...
To run this application, open the code file in IntelliJ IDEA 2024.2.0.1.  Run the applciation in IntelliJ, then you can access the application at http://localhost:8080/.
